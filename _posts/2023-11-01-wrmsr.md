...
![Modified LSTAR](https://idafchev.github.io/blog/assets/images/wrmsr/lstar_2.png){: .align-center}  
...
![Sysret](https://idafchev.github.io/blog/assets/images/wrmsr/sysret2.png){: .align-center}  
...
To find ROP gadgets I used [rp++](https://github.com/0vercl0k/rp). rp++ shows the offset to the gadget, so to find the actual virtual address, the Kernel Base Address should be found dynamically (using `EnumDeviceDrivers` method). The virtual address of the gadget can be found by adding the kernel base address and the offset.  
